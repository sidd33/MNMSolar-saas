    ...
    >
      ...
      {search.trim() === "" ? (
        <Card className="border-dashed h-64 flex flex-col items-center justify-center bg-[#F7FAFC] rounded-[2.5rem] border-slate-200 text-slate-400 gap-3">
          ...
          <p className="font-black uppercase tracking-widest text-[10px]">Select a project from the sidebar to view Purchase Orders</p>
        </Card>
      ) : filteredProjects.length === 0 ? (
        <Card className="border-dashed h-64 flex flex-col items-center justify-center bg-[#F7FAFC] rounded-[2.5rem] border-slate-200 text-slate-400 gap-3">
          <ShoppingCart size={48} className="opacity-20 mx-auto mb-4" />
          <p className="font-black uppercase tracking-widest text-[10px]">No projects pending Purchase Orders</p>
        </Card>
      ) : (
